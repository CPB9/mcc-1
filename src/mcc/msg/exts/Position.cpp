...
const bmcl::Option<mccgeo::Position>& TmPosition::position() const { return _position; }
const bmcl::Option<double>& TmPosition::positionAccuracy() const { return _positionAccuracy; }
