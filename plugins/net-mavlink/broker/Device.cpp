...
DItem::DItem(mccmsg::ProtocolId id, const caf::actor& a, caf::event_based_actor* self) : _a(a), _id(id), _self(self), _isActive(false)
{
}
...
void DItem::activated(bool isActive)
{
    _isActive = isActive;
}
}
